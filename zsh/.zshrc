...
opf() {
  ...
  if [[ -n "$dir" ]]; then
    cd "$dir" && echo "Went to the $dir project folder"
  else
    cd "$base"
  fi
}
...
export PATH=$PATH:/home/nguyennam/.spicetify

# bun completions
[ -s "/home/nguyennam/.bun/_bun" ] && source "/home/nguyennam/.bun/_bun"
...
# pnpm
export PNPM_HOME="/home/nguyennam/.local/share/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
